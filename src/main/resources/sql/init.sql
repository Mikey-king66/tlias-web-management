-- =====================================================
-- tlias-web-management 数据库初始化脚本
-- 班级表 (clazz) 与 学员表 (student)
-- =====================================================
...
(2, '黄埔班一期', '101', '2023-05-01', '2023-10-30', 1, 1, '2023-06-01 17:08:23', '2023-06-01 17:39:58'),
...
(8, 'JavaEE就业167期', '325', '2023-11-20', '2024-05-10', 1, 1, '2023-11-15 11:35:46', '2023-12-13 14:31:24'),
(9, 'Python就业12期', '302', '2024-01-10', '2024-07-15', 3, 4, '2024-01-05 09:15:30', '2024-01-05 09:15:30');
...
(1, '段誉', '2022000001', 1, '18800000001', '110120000300200001', 1, '北京市昌平区建材城西路1号', 1, '2021-07-01', 1, 0, 0, '2023-11-14 21:22:19', '2023-11-15 16:20:59'),
